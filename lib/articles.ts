...
export const articles: Article[] = [
  ...
  {
    id: 7,
    slug: 'helping-a-lost-pet',
    title: 'How to Help a Lost Pet You Find',
    excerpt: 'What to do when you find a lost pet — from approaching safely to reuniting them with their owner.',
    category: 'Community',
    readTime: '4 min read',
    featured: false,
    ...
    sections: [
      {
        type: 'paragraph',
        content: 'You spot a dog wandering alone in your neighborhood, or a cat shows up on your porch looking confused. What do you do? Finding a lost pet can be stressful, but with the right steps, you can help get them home safely.'
      },
      {
        type: 'heading',
        content: 'Approach Carefully'
      },
      {
        type: 'paragraph',
        content: 'A lost pet is scared and disoriented. Even the friendliest dog can react unpredictably when stressed. Move slowly, speak softly, and let the animal come to you. Avoid direct eye contact, which some animals see as threatening. Crouch down to appear smaller and less intimidating.'
      },
      {
        type: 'callout',
        content: 'If the animal looks injured, aggressive, or is a wild animal, don\'t try to handle it yourself. Call your local animal control for help.',
        variant: 'warning'
      },
      {
        type: 'heading',
        content: 'Check for ID Tags'
      },
      {
        type: 'paragraph',
        content: 'Once the pet is calm enough to approach, check their collar for any tags. Many pets wear traditional engraved tags with a phone number. If the pet has a NotAStray tag, just scan the QR code with your phone camera — you\'ll see the owner\'s contact info immediately. No app needed, no waiting. You can call or text the owner right from the profile page.'
      },
      {
        type: 'heading',
        content: 'Contact the Owner'
      },
      {
        type: 'paragraph',
        content: 'If you find a phone number on a tag or through a QR scan, call or text right away. Let the owner know where you are and that their pet is safe. Stay with the pet if you can — most owners will drop everything to come get their furry family member.'
      },
      {
        type: 'heading',
        content: 'If There\'s No ID'
      },
      {
        type: 'paragraph',
        content: 'No tags? Don\'t worry, there are still plenty of options:'
      },
      {
        type: 'list',
        content: '',
        items: [
          'Take the pet to a nearby vet or animal shelter to scan for a microchip. This is free and takes just a few seconds.',
          'Post on local social media groups like Nextdoor, Facebook lost pet groups, and community pages. Include a photo, your location, and the time you found them.',
          'Check sites like Pawboost, PetFBI, and your local shelter\'s found pet listings.',
          'Put up simple flyers in your neighborhood with a photo and your contact info.',
          'Contact your local animal control to report the found pet.'
        ]
      },
      {
        type: 'heading',
        content: 'Temporary Care Tips'
      },
      {
        type: 'paragraph',
        content: 'If you\'re keeping the pet while searching for the owner, here are the basics:'
      },
      {
        type: 'list',
        content: '',
        items: [
          'Offer fresh water right away. The pet may be dehydrated.',
          'Keep them in a secure area away from your own pets to avoid conflicts and prevent disease transmission.',
          'Provide a quiet, comfortable space. A bathroom or laundry room works well for temporary housing.',
          'Don\'t feed too much at once — a small meal is fine, but overeating can make a stressed animal sick.',
          'Take a clear photo for social media posts and flyers.'
        ]
      },
      {
        type: 'paragraph',
        content: 'Finding a lost pet and helping them get home is one of the kindest things you can do. A little patience and a few phone calls can make all the difference for a worried pet owner.'
      }
    ]
  },
  {
    id: 8,
    slug: 'preventing-pet-loss',
    title: 'Preventing Pet Loss: Securing Your Home and Yard',
    excerpt: 'Simple steps to make your home and yard escape-proof so your pet stays safe where they belong.',
    category: 'Prevention',
    readTime: '4 min read',
    featured: false,
    publishDate: '2026-03-15',
    ...
    sections: [
      {
        type: 'paragraph',
        content: 'Most pets don\'t run away because they want to leave — they escape because an opportunity presents itself. An open gate, a loose fence board, a door left ajar. The good news? Most escape routes are preventable with a little attention.'
      },
      {
        type: 'heading',
        content: 'Inspect Your Fence and Gates'
      },
      {
        type: 'paragraph',
        content: 'Walk your entire fence line and look for weak spots. Check for gaps at the bottom where a dog could dig under, loose boards that could be pushed aside, and sections that are low enough to jump over. Secure gates with self-closing hinges and latches that your pet can\'t nudge open. If your dog is a digger, consider burying chicken wire along the fence base.'
      },
      {
        type: 'heading',
        content: 'Prevent Door Dashing'
      },
      {
        type: 'paragraph',
        content: 'Some pets bolt for the door every time it opens. A few simple habits can stop this:'
      },
      {
        type: 'list',
        content: '',
        items: [
          'Train a "wait" command at doorways. Reward your pet for sitting before the door opens.',
          'Use baby gates to create a buffer zone near entry doors.',
          'Ask guests to enter and exit slowly, and let them know you have a door dasher.',
          'Keep your pet in another room when expecting deliveries or contractors.'
        ]
      },
      {
        type: 'heading',
        content: 'Secure Windows and Screens'
      },
      {
        type: 'paragraph',
        content: 'Cats especially are at risk of falling or pushing through window screens. Make sure all screens are firmly attached and free of tears. Consider pet-proof screens made of heavier-gauge material. Never leave windows wide open if your pet can reach them — a startled cat can push through a regular screen in seconds.'
      },
      {
        type: 'heading',
        content: 'Leash Training Matters'
      },
      {
        type: 'paragraph',
        content: 'A well-trained pet on a leash is much less likely to pull free and run off. Practice loose-leash walking regularly. Use a properly fitted harness instead of just a collar — harnesses are harder to slip out of and give you better control. Always double-check clasps and buckles before heading out.'
      },
      {
        type: 'heading',
        content: 'ID Tags and Microchips'
      },
      {
        type: 'paragraph',
        content: 'Prevention is the first line of defense, but accidents still happen. Make sure your pet always wears a collar with up-to-date ID tags. Get them microchipped as a permanent backup. Even the best precautions aren\'t foolproof — make sure your pet has a NotAStray tag as a backup so anyone who finds them can contact you instantly.'
      },
      {
        type: 'heading',
        content: 'Keep Your Info Current'
      },
      {
        type: 'paragraph',
        content: 'An ID tag with an old phone number is almost as useless as no tag at all. Whenever you move or change your number, update your tags, microchip registry, and NotAStray profile right away. Set a reminder every six months to double-check everything is accurate.'
      },
      {
        type: 'callout',
        content: 'The most common times for pet escapes are during holidays (fireworks), home renovations (open doors and gates), and moving day. Be extra vigilant during these situations.',
        variant: 'tip'
      }
    ]
  },
  {
    ...
    title: 'Emergency Preparedness for Pets',
    excerpt: 'How to build a pet emergency plan so you and your pet are ready for anything — from storms to evacuations.',
    category: 'Emergency',
    readTime: '5 min read',
    featured: false,
    publishDate: '2026-03-15',
    ...
    sections: [
      {
        type: 'paragraph',
        content: 'Natural disasters, severe weather, and unexpected emergencies don\'t give you much warning. If you have a plan for your family, you need one for your pets too. A little preparation now can save precious time when it matters most.'
      },
      {
        type: 'heading',
        content: 'Why You Need a Pet Emergency Plan'
      },
      {
        type: 'paragraph',
        content: 'During emergencies, shelters and rescue teams often can\'t accommodate pets right away. If you have to evacuate quickly, you don\'t want to be scrambling to find your pet\'s food, medications, or carrier. Pets also get frightened during storms and may run off if doors or fences are damaged. Having a plan means you can act fast and keep your pet safe.'
      },
      {
        type: 'heading',
        content: 'Build a Pet Emergency Kit'
      },
      {
        type: 'paragraph',
        content: 'Put together a grab-and-go kit and store it somewhere easy to reach. Here\'s what to include:'
      },
      {
        type: 'list',
        content: '',
        items: [
          ...
          'Any medications your pet takes, with dosage instructions.',
          'A sturdy carrier or crate — one per pet.',
          'Leash, harness, and an extra collar with ID tags.',
          'Recent photos of your pet in case you get separated.',
          'Copies of vaccination records and vet contact info.',
          'Poop bags, cat litter, and a small litter tray if needed.',
          'A favorite toy or blanket for comfort.'
        ]
      },
      {
        type: 'callout',
        content: 'Check your kit every six months. Replace expired food and medications, and update photos and documents.',
        variant: 'tip'
      },
      {
        type: 'heading',
        content: 'Make an Evacuation Plan'
      },
      {
        type: 'paragraph',
        content: 'Know where you\'ll go if you have to leave home, and make sure pets are part of the plan:'
      },
      {
        type: 'list',
        content: '',
        items: [
          'Identify pet-friendly hotels, shelters, or friends and family outside your area who can take you and your pet in.',
          'Know your evacuation routes and practice loading your pet into the car quickly.',
          'Keep your pet\'s carrier accessible — don\'t store it in a hard-to-reach spot.',
          'Have a plan for who grabs the pet if you\'re not home when an emergency strikes.'
        ]
      },
      {
        type: 'heading',
        content: 'Shelter-in-Place Tips'
      },
      {
        type: 'paragraph',
        content: 'If you\'re staying home during a storm or other emergency, keep your pet in an interior room away from windows. Close curtains to reduce noise and visual stress. Keep them leashed or in a carrier if there\'s any chance of structural damage — a scared pet will bolt through a broken window or door.'
      },
      {
        type: 'heading',
        content: 'Keep Records Accessible'
      },
      {
        type: 'paragraph',
        content: 'In an emergency, you might not have time to dig through files. Keep digital copies of your pet\'s medical records, vaccination history, and your vet\'s contact info on your phone. Your NotAStray profile stores your pet\'s medical info and your contact details in one place — accessible to anyone with a phone. If you get separated from your pet during an emergency, a finder can scan the tag and reach you immediately.'
      },
      {
        type: 'paragraph',
        content: 'Emergencies are stressful enough without worrying about your pet. A little planning goes a long way toward keeping your whole family safe — the four-legged members included.'
      }
    ]
  },
  {
    id: 10,
    slug: 'lost-pet-behavior',
    title: 'Understanding Pet Behavior When Lost',
    excerpt: 'Learn how dogs and cats behave when lost so you can search smarter and bring them home faster.',
    category: 'Education',
    readTime: '4 min read',
    featured: false,
    publishDate: '2026-03-15',
    ...
    sections: [
      {
        type: 'paragraph',
        content: 'When a pet goes missing, most owners assume they\'ll wander far from home. But lost pet behavior is more predictable than you might think. Understanding how your pet is likely to act can help you search in the right places at the right times.'
      },
      {
        type: 'heading',
        content: 'How Dogs Behave When Lost'
      },
      {
        type: 'paragraph',
        content: 'Dogs tend to keep moving. A friendly, outgoing dog may approach strangers and let itself be "rescued" fairly quickly. A shy or anxious dog, on the other hand, may run from people — even their own owner — and hide in secluded areas. Most lost dogs stay within a mile or two of where they went missing, though some can travel much farther if they panic and keep running.'
      },
      {
        type: 'heading',
        content: 'How Cats Behave When Lost'
      },
      {
        type: 'paragraph',
        content: 'Cats are very different from dogs when lost. Most cats hide. They find a dark, enclosed space — under a porch, in a garage, behind bushes — and they stay there, sometimes for days. Even outdoor cats tend to freeze and hide rather than roam when they\'re displaced from their territory. Indoor-only cats are especially likely to hunker down silently very close to home.'
      },
      {
        type: 'heading',
        content: 'Why Pets Don\'t Always Come When Called'
      },
      {
        type: 'paragraph',
        content: 'This is one of the most frustrating things for owners. Your pet knows their name, comes to you every day at home, but won\'t respond when lost. Fear overrides training. A panicked pet goes into survival mode. Their instinct tells them to stay hidden and quiet. This is especially true for cats and shy dogs. Don\'t take it personally — keep searching even if they don\'t answer.'
      },
      {
        type: 'heading',
        content: 'Search Radius by Personality'
      },
      {
        type: 'paragraph',
        content: 'Your pet\'s personality affects how far they\'re likely to go:'
      },
      {
        type: 'list',
        content: '',
        items: [
          'Bold, friendly dogs: May travel several blocks but are likely to approach people. Check with neighbors and local businesses.',
          'Shy, anxious dogs: Usually hide within a few blocks. Search quiet areas like under porches, in bushes, and behind buildings.',
          'Indoor cats: Almost always within a 3-5 house radius. Search your immediate neighbors\' yards, garages, and sheds thoroughly.',
          'Outdoor cats: May range wider but usually stay within their known territory. Expand your search gradually from home.'
        ]
      },
      {
        type: 'heading',
        content: 'Best Times to Search'
      },
      {
        type: 'paragraph',
        content: 'Lost pets are most active during dawn and dusk when it\'s quieter and cooler. Night searches can also be effective — bring a flashlight and look for eye reflection. During the heat of the day, most lost pets are resting in shaded, hidden spots. For cats especially, a quiet search at night when the neighborhood is still gives you the best chance of hearing a meow or spotting movement.'
      },
      {
        type: 'heading',
        content: 'Use Scent to Your Advantage'
      },
      {
        type: 'list',
        content: '',
        items: [
          'Place your pet\'s bed, a worn shirt, or their favorite blanket outside your door. Familiar scents can draw them back.',
          'Put their litter box outside if you\'re looking for a cat — they can smell it from surprisingly far away.',
          'Leave a bowl of water (not food, which attracts other animals) near your door.',
          'Avoid washing the area around your home with strong cleaners that could mask familiar scents.'
        ]
      },
      {
        type: 'heading',
        content: 'They\'re Probably Closer Than You Think'
      },
      {
        type: 'paragraph',
        content: 'Studies of lost pet recovery show that most pets are found close to home. Don\'t start by driving miles away — start with your own yard, your neighbors\' properties, and the immediate streets around your home. Search slowly, look low (under things), and check the same spots multiple times. A pet that wasn\'t there this morning might be there tonight.'
      },
      {
        type: 'callout',
        content: 'A QR tag on your pet\'s collar means that anyone who finds them — a neighbor, a jogger, a kid at the park — can scan it and contact you in seconds, without needing to catch or transport the animal. The faster someone can reach you, the faster your pet comes home.',
        variant: 'tip'
      }
    ]
  },
  {
    id: 11,
    slug: 'pet-safety-for-kids',
    title: 'Pet Safety for Kids: Teaching Children to Help',
    excerpt: 'Simple ways to teach your kids how to be safe around pets and even help bring lost ones home.',
    category: 'Family',
    readTime: '4 min read',
    featured: false,
    publishDate: '2026-03-15',
    ...
    sections: [
      {
        type: 'paragraph',
        content: 'Kids and pets are a natural match. But young children don\'t always know how to read an animal\'s signals, and that can lead to scratches, bites, or a scared pet bolting out the door. The good news is that teaching your kids about pet safety doesn\'t have to be complicated. A few simple lessons can turn your child into your pet\'s best ally.'
      },
      {
        type: 'heading',
        content: 'Teaching Gentle Handling'
      },
      {
        type: 'paragraph',
        content: 'The number one rule for kids around pets is "gentle hands." Show your child how to pet softly along the back or under the chin instead of grabbing, squeezing, or pulling tails and ears. Practice on a stuffed animal first if your child is very young.'
      },
      {
        type: 'list',
        content: '',
        items: [
          'Always pet with an open hand, never grab or squeeze',
          'Avoid touching a pet\'s face, tail, or paws until the pet is comfortable',
          'Never approach a pet while it\'s eating or sleeping',
          'Let the pet come to you instead of chasing it',
          'Use a calm, quiet voice around animals'
        ]
      },
      {
        type: 'heading',
        content: 'Reading Pet Body Language'
      },
      {
        type: 'paragraph',
        content: 'Teach your kids to look at what the pet is "saying" with its body. A wagging tail and relaxed ears usually mean a happy dog. A tucked tail, flattened ears, or growling means "back off." For cats, a swishing tail or flattened ears are warning signs. Make it a game — ask your child, "Does the kitty look happy or grumpy right now?"'
      },
      {
        type: 'callout',
        content: 'If a pet walks away from your child, let it go. Teach kids that "the pet is saying it needs a break" and to try again later.',
        variant: 'tip'
      },
      {
        type: 'heading',
        content: 'Getting Kids Involved in Pet ID'
      },
      {
        type: 'paragraph',
        content: 'Kids love having a job. Let them help set up or update your pet\'s NotAStray profile. They can pick the best photo, help write the pet\'s description, or double-check that the tag is clipped securely to the collar. This gives them a sense of ownership over their pet\'s safety and teaches them why ID matters.'
      },
      {
        type: 'paragraph',
        content: 'Scanning a QR tag is simple enough that even a kid can do it — and it might just save a pet. Show your child how to use a phone camera to scan a QR code so they know what to do if they ever find a lost pet wearing one.'
      },
      {
        type: 'heading',
        content: 'What to Do If They Find a Lost Pet'
      },
      {
        type: 'paragraph',
        content: 'Teach your kids a simple plan for when they spot a loose or lost pet in the neighborhood:'
      },
      {
        type: 'numbered-list',
        content: '',
        items: [
          'Don\'t chase the animal — it could run into traffic or get scared and bite',
          'Tell an adult right away',
          'If the pet has a tag, ask an adult to help scan the QR code or read the tag info',
          'Stay calm and speak softly if the pet approaches on its own',
          'Never try to pick up an unfamiliar animal'
        ]
      },
      {
        type: 'heading',
        content: 'Age-Appropriate Responsibilities'
      },
      {
        type: 'paragraph',
        content: 'Giving kids pet-related chores builds empathy and responsibility. Match the task to the age:'
      },
      {
        type: 'list',
        content: '',
        items: [
          'Ages 3-5: Help fill the water bowl, brush the pet with supervision',
          'Ages 6-8: Feed the pet on a schedule, help with baths, check that the collar and tag are secure',
          'Ages 9-12: Walk the dog with an adult nearby, clean up the yard, help update the pet\'s profile',
          'Teens: Walk the dog independently, take on full feeding duties, help with vet visits'
        ]
      },
      {
        type: 'callout',
        content: 'Never leave very young children unsupervised with a pet, no matter how gentle the animal seems. Even the calmest pet can react unexpectedly if startled or hurt.',
        variant: 'warning'
      },
      {
        type: 'paragraph',
        content: 'Teaching your kids about pet safety isn\'t just about preventing accidents. It\'s about raising compassionate people who know how to look out for animals. Start small, keep it fun, and let your child grow into a confident and caring pet guardian.'
      }
    ]
  },
  {
    id: 12,
    slug: 'pet-safety-checklist',
    title: 'The Ultimate Pet Safety Checklist',
    excerpt: 'A practical checklist covering home safety, yard safety, ID, emergency prep, and seasonal considerations for your pet.',
    category: 'Safety',
    readTime: '4 min read',
    featured: false,
    publishDate: '2026-03-15',
    ...
    sections: [
      {
        type: 'paragraph',
        content: 'You\'d be surprised how many common household items and everyday situations can put your pet at risk. This checklist covers the basics so you can do a quick safety sweep and make sure you\'re not overlooking anything. Bookmark it and revisit it a couple of times a year.'
      },
      {
        type: 'heading',
        content: 'Home Safety'
      ...
      {
        type: 'paragraph',
        content: 'Start inside your house. Pets are curious, and they explore with their mouths.'
      },
      {
        type: 'numbered-list',
        content: '',
        items: [
          'Move toxic houseplants out of reach (lilies, pothos, sago palms, and aloe are all harmful to pets)',
          'Store cleaning products, medications, and chemicals in closed cabinets',
          'Pick up small objects like rubber bands, hair ties, coins, and batteries that could be swallowed',
          'Secure trash cans with lids — food scraps like chocolate, grapes, and chicken bones are dangerous',
          'Cover or hide electrical cords that a puppy or kitten might chew',
          'Keep toilet lids closed if your pet drinks from them — cleaning chemicals linger'
        ]
      },
      {
        type: 'heading',
      ...
      {
        type: 'paragraph',
        content: 'Your backyard should be a safe zone, not a source of danger.'
      },
      {
        type: 'numbered-list',
        content: '',
        items: [
          'Walk your fence line and check for gaps, loose boards, or dig spots',
          'Make sure gates latch securely — a gate that blows open is a common escape route',
          'Fence off pools, ponds, or hot tubs — not all dogs are strong swimmers',
          'Avoid cocoa mulch in garden beds (it\'s toxic to dogs)',
          'Store lawn chemicals, fertilizers, and rat poison in a locked shed or garage',
          'Remove standing water to prevent mosquitoes and discourage drinking from puddles'
        ]
      },
      {
        type: 'heading',
        content: 'ID and Tracking'
      },
      {
        type: 'paragraph',
        content: 'If your pet gets out, proper identification is the single biggest factor in getting them home.'
      },
      {
        type: 'numbered-list',
        content: '',
        items: [
          'Get your pet microchipped and keep the registration info up to date',
          'Attach a traditional ID tag with your phone number to the collar',
          'Set up a NotAStray QR tag with a current photo, your contact info, and any medical notes',
          'Test your QR tag by scanning it yourself to make sure everything looks right',
          'Check that the collar fits properly — you should be able to fit two fingers under it'
        ]
      },
      {
        type: 'callout',
        content: 'Microchips are great, but they require a vet or shelter with a scanner. A NotAStray QR tag lets anyone with a smartphone help your pet get home instantly.',
        variant: 'tip'
      },
      {
        type: 'heading',
      ...
      {
        type: 'paragraph',
        content: 'Don\'t wait for an emergency to figure out your plan.'
      },
      {
        type: 'numbered-list',
        content: '',
        items: [
          'Save your vet\'s number and the nearest emergency animal hospital in your phone',
          'Keep a pet first-aid kit with gauze, adhesive tape, antiseptic wipes, and tweezers',
          'Store a week\'s worth of food, water, and any medications in a grab-and-go bag',
          'Have a recent photo of your pet saved on your phone for lost-pet flyers',
          'Know who will care for your pet if you\'re hospitalized or need to evacuate'
        ]
      },
      {
        type: 'heading',
        content: 'Seasonal Checks'
      },
      {
        type: 'paragraph',
        content: 'Different seasons bring different risks. Do a quick check as the weather changes.'
      },
      {
        type: 'list',
        content: '',
        items: [
          'Summer: Never leave your pet in a parked car. Provide shade and fresh water outdoors. Walk on grass instead of hot pavement.',
          'Winter: Wipe paws after walks to remove salt and ice-melt chemicals. Provide a warm shelter if your pet spends time outdoors.',
          'Spring: Watch for antifreeze puddles in the garage and driveway. Check for ticks after outdoor time.',
          'Holidays: Secure decorations, keep candy and food out of reach, and make sure your pet\'s ID is current before celebrations.'
        ]
      },
      {
        type: 'callout',
        content: 'Print this checklist and tape it to your fridge. A quick review once a season takes five minutes and could prevent a trip to the emergency vet.',
        variant: 'info'
      }
    ]
  },
  {
    id: 13,
    slug: 'community-pet-safety',
    title: 'Community Involvement in Pet Safety',
    excerpt: 'How neighbors, local groups, and everyday people can work together to keep pets safe and bring lost ones home faster.',
    category: 'Community',
    readTime: '4 min read',
    featured: false,
    publishDate: '2026-03-15',
    ...
    sections: [
      {
        type: 'paragraph',
        content: 'Keeping pets safe isn\'t just the owner\'s job. When a whole neighborhood looks out for the animals in it, lost pets get found faster, strays get help sooner, and everyone — human and animal — benefits. Here\'s how you can be part of that effort without it taking over your life.'
      },
      {
        type: 'heading',
        content: 'Get to Know the Pets in Your Neighborhood'
      },
      {
        type: 'paragraph',
        content: 'You probably recognize most of your neighbors by sight. Start doing the same with their pets. Knowing that the golden retriever belongs to the family on the corner means you\'ll notice immediately if you see it wandering alone three blocks away. A quick "hey, your dog is loose" text can prevent a full-blown search.'
      },
      {
        type: 'heading',
        content: 'What to Do When You See a Loose Pet'
      },
      {
        type: 'paragraph',
        content: 'Spotting a lost or loose pet can be stressful, but a calm approach makes all the difference.'
      },
      {
        type: 'numbered-list',
        content: '',
        items: [
          'Stay calm and don\'t chase the animal — this usually makes them run farther',
          'Crouch down and speak softly to see if the pet will approach you',
          'Check for a collar or tag. If there\'s a QR code, scan it with your phone camera',
          'If the pet seems friendly and safe to approach, try to contain it in a yard or garage',
          'Call your local animal control or non-emergency police line if you can\'t safely contain the animal',
          'Post on local social media groups (more on that below)'
        ]
      },
      {
        type: 'callout',
        content: 'When someone in your neighborhood scans a NotAStray tag, the owner gets an instant alert with a location — that\'s community looking out for each other.',
        variant: 'info'
      },
      {
        type: 'heading',
        content: 'Get Involved with Local Shelters and Rescues'
      },
      {
        type: 'paragraph',
        content: 'You don\'t have to adopt or foster to make a difference. Local shelters need volunteers for all kinds of tasks — walking dogs, socializing cats, transporting animals to vet appointments, or even just sharing their social media posts to boost adoption visibility. Many shelters also run low-cost microchipping and ID tag events that you can help promote.'
      },
      {
        type: 'heading',
        content: 'Start a Neighborhood Pet Watch'
      },
      {
        type: 'paragraph',
        content: 'If your neighborhood has a watch program for crime prevention, the same idea works for pets. It can be as simple as a group chat where people post if they see a loose animal, share photos of new pets in the area, or give a heads-up about hazards like open gates or coyote sightings.'
      },
      {
        type: 'list',
        content: '',
        items: [
          'Create a group chat on WhatsApp, Nextdoor, or Facebook for pet sightings',
          'Share photos of neighborhood pets so everyone can identify them',
          'Post alerts when you see a loose or unfamiliar animal',
          'Share info about local pet events, vaccination clinics, or adoption drives'
        ]
      },
      {
        type: 'heading',
      ...
      {
        type: 'paragraph',
        content: 'Social media is one of the fastest ways to reunite a lost pet with its owner. Most cities have dedicated "lost and found pets" groups on Facebook. If you find or spot a loose pet, post a clear photo with the location and time. Share posts from others too — you never know whose friend-of-a-friend might recognize the animal.'
      },
      {
        type: 'heading',
        content: 'How Scanning a QR Tag Makes You Part of the Solution'
      },
      {
        type: 'paragraph',
        content: 'You don\'t need special training or equipment to help a lost pet. If you see an animal with a QR tag on its collar, just point your phone camera at it. That single scan pulls up the pet\'s profile and sends the owner a real-time alert with your approximate location. You\'ve just shortened a potentially days-long search to minutes.'
      },
      {
        type: 'paragraph',
        content: 'Encourage your neighbors to look for tags on loose animals and to set up QR tags on their own pets. The more pets in your area that have scannable ID, the safer the whole neighborhood becomes.'
      },
      {
        type: 'callout',
        content: 'You don\'t need to download an app to scan a NotAStray tag. Any modern smartphone camera will read the QR code automatically.',
        variant: 'tip'
      },
      {
        type: 'paragraph',
        content: 'Pet safety is a team sport. When neighbors pay attention, share information, and take thirty seconds to scan a tag or post a photo, lost pets get home faster and fewer animals end up in shelters. Be that neighbor.'
      }
    ]
  }
]
