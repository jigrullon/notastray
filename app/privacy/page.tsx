                ...
                <div className="bg-white dark:bg-gray-800 shadow sm:rounded-lg overflow-hidden">
                    <div className="px-6 py-8 sm:p-10">
                        ...
                        <div className="prose prose-blue max-w-none text-gray-600 dark:text-gray-400 space-y-6">
                            ...
                            <section>
                                <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">5. Data Sharing and Selling</h2>
                            ...
                            <section>
                                <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">6. SMS Notifications</h2>
                                <p>
